...
nations = """ Tezza has bot access levels we call as *"Nation Levels"*
...
Owner has complete bot access, including bot adminship in chats Tezza is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in Tezza.
...
\n*Disclaimer*: The Nation levels in Tezza are there for troubleshooting, support, banning potential scammers.
Report abuse or ask us more on these at [Tezza Support](https://t.me/tezzasupportgroup).
"""
